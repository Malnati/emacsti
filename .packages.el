...
(when (member system-type '(gnu/linux gnu x))
  (use-package xref-js2
    ...
    ;; (define-key xref-js2 (kbd "C-c C-e") #'js2-mode-hide-element)
    ;; (define-key xref-js2 (kbd "C-c C-s") #'js2-mode-show-element)
    ;; (define-key xref-js2 (kbd "C-c C-a") #'js2-mode-show-all)
    ;; (define-key xref-js2 (kbd "C-c C-f") #'js2-mode-toggle-hide-functions)
    ;; (define-key xref-js2 (kbd "C-c C-t") #'js2-mode-toggle-hide-comments)
    ;; (define-key xref-js2 (kbd "C-c C-o") #'js2-mode-toggle-element)
    ;; (define-key xref-js2 (kbd "C-c C-w") #'js2-mode-toggle-warnings-and-errors)
    ;; (define-key xref-js2 [down-mouse-3] #'js2-down-mouse-3)
    ;; (define-key xref-js2 [remap js-find-symbol] #'js2-jump-to-definition)
